...
Version  : 2.4.5
Release  : 44
URL      : https://github.com/FluidSynth/fluidsynth/archive/v2.4.5/fluidsynth-2.4.5.tar.gz
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.4.5/fluidsynth-2.4.5.tar.gz
...
%prep
%setup -q -n fluidsynth-2.4.5
cd %{_builddir}/fluidsynth-2.4.5
pushd ..
cp -a fluidsynth-2.4.5 buildavx2
popd
pushd ..
cp -a fluidsynth-2.4.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744641472
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfluidsynth.so.3.3.5
/V4/usr/lib64/libfluidsynth.so.3.3.5
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.3.5
