...
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.4.7/fluidsynth-2.4.7.tar.gz
...
%prep
%setup -q -n fluidsynth-2.4.7
cd %{_builddir}/fluidsynth-2.4.7
pushd ..
cp -a fluidsynth-2.4.7 buildavx2
popd
pushd ..
cp -a fluidsynth-2.4.7 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752603719
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfluidsynth.so.3.3.7
/V4/usr/lib64/libfluidsynth.so.3.3.7
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.3.7
