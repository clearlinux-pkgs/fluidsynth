...
Version  : 2.3.6
Release  : 38
URL      : https://github.com/FluidSynth/fluidsynth/archive/v2.3.6/fluidsynth-2.3.6.tar.gz
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.3.6/fluidsynth-2.3.6.tar.gz
...
%prep
%setup -q -n fluidsynth-2.3.6
cd %{_builddir}/fluidsynth-2.3.6
pushd ..
cp -a fluidsynth-2.3.6 buildavx2
popd
pushd ..
cp -a fluidsynth-2.3.6 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722872785
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfluidsynth.so.3.2.4
/V4/usr/lib64/libfluidsynth.so.3.2.4
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.2.4
