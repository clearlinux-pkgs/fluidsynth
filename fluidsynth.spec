...
%prep
%setup -q -n fluidsynth-2.4.4
cd %{_builddir}/fluidsynth-2.4.4
pushd ..
cp -a fluidsynth-2.4.4 buildavx2
popd
pushd ..
cp -a fluidsynth-2.4.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742404736
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfluidsynth.so.3.3.4
/V4/usr/lib64/libfluidsynth.so.3.3.4
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.3.4
