...
Version  : 2.2.2
Release  : 8
URL      : https://github.com/FluidSynth/fluidsynth/archive/v2.2.2/fluidsynth-2.2.2.tar.gz
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.2.2/fluidsynth-2.2.2.tar.gz
...
%prep
%setup -q -n fluidsynth-2.2.2
cd %{_builddir}/fluidsynth-2.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627492102
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/fluidsynth-2.2.2/LICENSE %{buildroot}/usr/share/package-licenses/fluidsynth/731a8eff333b8f7053ab2220511b524c87a75923
pushd clr-build-avx2
%make_install_avx2  || :
popd
pushd clr-build
...
/usr/lib64/haswell/libfluidsynth.so.3.0.2
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.0.2
