...
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.1.5/fluidsynth-2.1.5.tar.gz
...
%prep
%setup -q -n fluidsynth-2.1.5
cd %{_builddir}/fluidsynth-2.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605556712
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/fluidsynth-2.1.5/LICENSE %{buildroot}/usr/share/package-licenses/fluidsynth/731a8eff333b8f7053ab2220511b524c87a75923
pushd clr-build
%make_install
popd
