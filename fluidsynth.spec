...
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.2.9/fluidsynth-2.2.9.tar.gz
...
%prep
%setup -q -n fluidsynth-2.2.9
cd %{_builddir}/fluidsynth-2.2.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662494137
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libfluidsynth.so.3.1.2
/usr/lib64/glibc-hwcaps/x86-64-v4/libfluidsynth.so.3
/usr/lib64/glibc-hwcaps/x86-64-v4/libfluidsynth.so.3.1.2
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.1.2
