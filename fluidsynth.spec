...
Version  : 2.4.6
Release  : 45
URL      : https://github.com/FluidSynth/fluidsynth/archive/v2.4.6/fluidsynth-2.4.6.tar.gz
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.4.6/fluidsynth-2.4.6.tar.gz
...
%prep
%setup -q -n fluidsynth-2.4.6
cd %{_builddir}/fluidsynth-2.4.6
pushd ..
cp -a fluidsynth-2.4.6 buildavx2
popd
pushd ..
cp -a fluidsynth-2.4.6 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746455204
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfluidsynth.so.3.3.6
/V4/usr/lib64/libfluidsynth.so.3.3.6
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.3.6
