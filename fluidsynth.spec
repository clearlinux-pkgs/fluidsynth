...
Version  : 2.2.8
Release  : 21
URL      : https://github.com/FluidSynth/fluidsynth/archive/v2.2.8/fluidsynth-2.2.8.tar.gz
Source0  : https://github.com/FluidSynth/fluidsynth/archive/v2.2.8/fluidsynth-2.2.8.tar.gz
...
%prep
%setup -q -n fluidsynth-2.2.8
cd %{_builddir}/fluidsynth-2.2.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657862627
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/fluidsynth-2.2.8/LICENSE %{buildroot}/usr/share/package-licenses/fluidsynth/731a8eff333b8f7053ab2220511b524c87a75923
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build-avx512
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libfluidsynth.so
/usr/lib64/glibc-hwcaps/x86-64-v4/libfluidsynth.so
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/glibc-hwcaps/x86-64-v3/libfluidsynth.so.3
/usr/lib64/glibc-hwcaps/x86-64-v3/libfluidsynth.so.3.1.1
/usr/lib64/glibc-hwcaps/x86-64-v4/libfluidsynth.so.3
/usr/lib64/glibc-hwcaps/x86-64-v4/libfluidsynth.so.3.1.1
/usr/lib64/libfluidsynth.so.3
/usr/lib64/libfluidsynth.so.3.1.1
