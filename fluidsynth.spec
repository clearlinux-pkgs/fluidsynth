...
%prep
%setup -q -n fluidsynth-2.3.0
cd %{_builddir}/fluidsynth-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667422630
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libfluidsynth.so.3.1.3
/usr/lib64/glibc-hwcaps/x86-64-v4/libfluidsynth.so.3
/usr/lib64/glibc-hwcaps/x86-64-v4/libfluidsynth.so.3.1.3
